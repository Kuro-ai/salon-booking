        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 p-6 max-w-7xl">
            @php
                $menuItems = [
                    ...
                    ['route' => 'admin.orders', 'label' => 'Movies', 'icon' => '<svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" viewBox="0 -960 960 960"><path d="M160-240v-320zm0 80q-33 0-56.5-23.5T80-240v-480q0-33 23.5-56.5T160-800l80 160h120l-80-160h80l80 160h120l-80-160h80l80 160h120l-80-160h120q33 0 56.5 23.5T880-720v160H160v320h320v80zm400 40v-123l221-220q9-9 20-13t22-4q12 0 23 4.5t20 13.5l37 37q8 9 12.5 20t4.5 22-4 22.5-13 20.5L683-120zm300-263-37-37zM620-180h38l121-122-18-19-19-18-122 121zm141-141-19-18 37 37z"/></svg>'], // Clapperboard Icon
