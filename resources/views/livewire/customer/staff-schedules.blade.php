    ...
    <ul>
        @foreach ($schedules as $schedule)
            <li wire:key="schedule-{{ $schedule['id'] }}">
                <button 
                    x-on:click="if(confirm('Are you sure you want to book this slot? The booking is automatically cancelled if you are late for half an hour!')) $wire.confirmBooking({{ $schedule['id'] }})"
