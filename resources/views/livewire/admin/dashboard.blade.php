<div class="p-6">
    ...
    <div class="flex justify-center items-center min-h-screen bg-gray-100 dark:bg-gray-900 py-10 mb-6">
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 p-6 max-w-7xl">
            @php
                $menuItems = [
                    ...
                    ['route' => 'admin.orders', 'label' => 'Orders', 'icon' => '<svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" viewBox="0 -960 960 960"><path d="M160-240v-320zm0 80q-33 0-56.5-23.5T80-240v-480q0-33 23.5-56.5T160-800l80 160h120l-80-160h80l80 160h120l-80-160h80l80 160h120l-80-160h120q33 0 56.5 23.5T880-720v160H160v320h320v80zm400 40v-123l221-220q9-9 20-13t22-4q12 0 23 4.5t20 13.5l37 37q8 9 12.5 20t4.5 22-4 22.5-13 20.5L683-120zm300-263-37-37zM620-180h38l121-122-18-19-19-18-122 121zm141-141-19-18 37 37z"/></svg>'], // Clapperboard Icon
                    ['route' => 'admin.users', 'label' => 'Users', 'icon' => '<svg width="60" height="60" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                                               ...
                                                                                               '],
                    ['route' => 'admin.coupons', 'label' => 'Coupons', 'icon' => '<svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" viewBox="0 -960 960 960"><path d="M160-120v-240h640v240h-80v-160H240v160zm20-280q-25 0-42.5-17.5T120-460t17.5-42.5T180-520t42.5 17.5T240-460t-17.5 42.5T180-400m100 0v-360q0-33 23.5-56.5T360-840h240q33 0 56.5 23.5T680-760v360zm500 0q-25 0-42.5-17.5T720-460t17.5-42.5T780-520t42.5 17.5T840-460t-17.5 42.5T780-400m-420-80h240v-280H360zm0 0h240z"/></svg>'], // Seat Icon
                    ['route' => 'admin.advertisements', 'label' => 'Advertisement', 'icon' => '<svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" viewBox="0 -960 960 960"><path d="M200-80q-33 0-56.5-23.5T120-160v-560q0-33 23.5-56.5T200-800h40v-80h80v80h320v-80h80v80h40q33 0 56.5 23.5T840-720v560q0 33-23.5 56.5T760-80zm0-80h560v-400H200zm0-480h560v-80H200zm0 0v-80zm280 240q-17 0-28.5-11.5T440-440t11.5-28.5T480-480t28.5 11.5T520-440t-11.5 28.5T480-400m-160 0q-17 0-28.5-11.5T280-440t11.5-28.5T320-480t28.5 11.5T360-440t-11.5 28.5T320-400m320 0q-17 0-28.5-11.5T600-440t11.5-28.5T640-480t28.5 11.5T680-440t-11.5 28.5T640-400M480-240q-17 0-28.5-11.5T440-280t11.5-28.5T480-320t28.5 11.5T520-280t-11.5 28.5T480-240m-160 0q-17 0-28.5-11.5T280-280t11.5-28.5T320-320t28.5 11.5T360-280t-11.5 28.5T320-240m320 0q-17 0-28.5-11.5T600-280t11.5-28.5T640-320t28.5 11.5T680-280t-11.5 28.5T640-240"/></svg>'], // Calendar Icon
                    ['route' => 'admin.services', 'label' => 'Services', 'icon' => '<svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" viewBox="0 -960 960 960"><path d="M533-440q-32-45-84.5-62.5T340-520t-108.5 17.5T147-440zM40-360q0-109 91-174.5T340-600t209 65.5T640-360zm0 160v-80h600v80zM720-40v-80h56l56-560H450l-10-80h200v-160h80v160h200L854-98q-3 25-22 41.5T788-40zm0-80h56zM80-40q-17 0-28.5-11.5T40-80v-40h600v40q0 17-11.5 28.5T600-40zm260-400"/></svg>'], // Food Icon
                    ['route' => 'admin.staff', 'label' => 'Staff', 'icon' => '<svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" viewBox="0 -960 960 960"><path d="M240-80q-33 0-56.5-23.5T160-160v-640q0-33 23.5-56.5T240-880h480q33 0 56.5 23.5T800-800v640q0 33-23.5 56.5T720-80zm0-80h480v-640h-80v280l-100-60-100 60v-280H240zm0 0v-640zm200-360 100-60 100 60-100-60z"/></svg>'], // Ticket Icon
                    ['route' => 'admin.staff-schedules', 'label' => 'Staff', 'icon' => '<svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" viewBox="0 -960 960 960"><path d="M240-80q-33 0-56.5-23.5T160-160v-640q0-33 23.5-56.5T240-880h480q33 0 56.5 23.5T800-800v640q0 33-23.5 56.5T720-80zm0-80h480v-640h-80v280l-100-60-100 60v-280H240zm0 0v-640zm200-360 100-60 100 60-100-60z"/></svg>'], // Ticket Icon
                ];
            @endphp
